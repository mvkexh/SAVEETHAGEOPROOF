        ...
        viewModelScope.launch {
            try {
                ...
                try {
                    ...
                    Log.w(TAG, "Firestore fetch failed, trying local fallback: ${e.message}")
                }
                ...
                if (localItem != null) {
                    ...
                    _uiState.value = DetailsState(isLoading = false, errorMessage = "Details not found locally or on cloud.")
                }
            } catch (e: Exception) {
